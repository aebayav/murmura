...
import { FaHome, FaUser, FaQuestionCircle, FaSignOutAlt, FaPlus, FaDoorOpen } from "react-icons/fa"
...
const NavBar = ({ onPostCreated }) => {
    ...
    if(userToken){
     return(
        <nav className="fixed left-0 top-0 h-screen w-64 bg-surface-primary border-r-2 border-border-primary flex flex-col px-4 py-6">
            {/* Logo/Brand Section */}
